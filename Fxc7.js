...
* Author MhankBarBar, Farhan , ZansLord
...
prefix = "!"
name = "~ ZANS BOT"
rdaftar = "TERIMA KASIH TELAH DAFTAR MENJADI TEMEN ZANSBOT😁"
rmenu = "HAI TEMEN ZANSBOT👋 JANGAN LUPA DONASI YAA:)"
				...
				default:
                  ...
                  reply(`Maaf Kak, Command *${prefix}${command}* Tidak Terdaftar Di Dalam Database *${prefix}menu*`)
					...
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[ZANSBOT]','aqua'), 'Command Tidak Terdaftar', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {
